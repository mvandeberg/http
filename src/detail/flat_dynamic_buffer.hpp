...
#ifndef BOOST_HTTP_DETAIL_FLAT_DYNAMIC_BUFFER_HPP
#define BOOST_HTTP_DETAIL_FLAT_DYNAMIC_BUFFER_HPP
...
/** A fixed-capacity linear buffer with dynamic-buffer semantics.
...
public:
    ...
    using const_buffers_type = capy::const_buffer;

    /// The MutableBufferSequence type for writable bytes.
    using mutable_buffers_type = capy::mutable_buffer;
